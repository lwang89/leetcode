 ...
 * The array is so big so that you can not get the length of the whole array directly, and you can only access the
 * kth number by ArrayReader.get(k) (or ArrayReader->get(k) for C++).
 *
